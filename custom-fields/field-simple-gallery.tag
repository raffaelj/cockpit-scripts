// version: 0.1.0
// usage: https://github.com/raffaelj/cockpit-scripts/tree/master/custom-fields/field-simple-gallery.md

App.Utils.renderer['simple-gallery'] = function(v) {
    return App.Utils.renderer.gallery(v);
};
                        ...
                        <div class="uk-bg-transparent-pattern uk-position-relative" style="min-height:120px;">
                            ...
                            <div class="uk-position-absolute uk-position-cover uk-flex uk-flex-middle">
                                <div class="uk-width-1-1 uk-text-center">
                                    <cp-thumbnail src="{ ASSETS_URL+img.path }" height="120"></cp-thumbnail>
                                </div>
                            </div>
                        </div>
