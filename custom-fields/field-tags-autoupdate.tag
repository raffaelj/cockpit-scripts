// version: 0.1.0
// usage: https://github.com/raffaelj/cockpit-scripts/tree/master/custom-fields/field-tags-autoupdate.md

App.Utils.renderer['tags-autoupdate'] = function(v) {
    return App.Utils.renderer.tags(v);
};

<field-tags-autoupdate>
    ...
    <script>
        ...
        this.on('mount', function(){
            ...
            App.request('/get-all-available-tags').then(function(data) {
                if (data) {
